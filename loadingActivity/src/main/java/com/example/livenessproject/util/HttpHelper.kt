...
class HttpHelper {
    ...
    companion object {
        fun loginWithPassword(username: String, password: String): String {
            ...
            return postRequestWrapper("http://3.0.121.132:3000/auth/login", json)
        }
        ...
        fun oneToOneComparison(img1base64: String, img2base64: String): String {
            ...
            return postRequestWrapper("http://3.0.121.132:3000/test/compare", json)
        }

        fun oneToManyComparison(imgbase64: String): String {
            val json = "{\"img\":\"data:image/jpeg;base64,$imgbase64\"}"
            return postRequestWrapper("http://3.0.121.132:3000/auth/loginface", json)
        }

        private fun postRequestWrapper(url: String, json: String): String{
